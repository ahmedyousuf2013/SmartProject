...
var WebSocketManager = (function () {
    ...
    var constructor = function (url) {
        ...
        var Message = function (messageType, data) {
            this.$type = 'SmartProject.Model.Common.Networking.Message';
        ...
        var InvocationDescriptor = function (methodName, args, identifier) {
            this.$type = 'WebSocketManager.Common.SmartProject.Model.Common.InvocationDescriptor';
        ...
        var InvocationResult = function (identifier, result, exception) {
            this.$type = 'SmartProject.Model.Common.Network.InvocationResult';
            this.result = result;
            ...
            if (exception !== undefined) {
                this.exception = {
                    $type: "SmartProject.Model.Common.Networking.RemoteException",
                    message: exception
                }
            }
        };
